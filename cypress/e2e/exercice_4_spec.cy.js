describe("Validations Exercice 4: ", () => {
    ...
    it("Should have Bold and centered h1", () => {
        cy.get("h1").should("exist").and("have.css", "font-weight", "700").and("have.css", "text-align", "center");
    });
    ...
    it("Should have main displayed with flexbox", () => {
        cy.get("main").should("have.css", "display", "flex").and("have.css", "flex-direction", "row");
    });
    ...
    it("Should have a Gray border of 1px", () => {
        cy.get("aside").should("have.css", "border-style", "solid").and("have.css", "border-color", "rgb(204, 204, 204)").and("have.css", "border-width", "1px");
    });
